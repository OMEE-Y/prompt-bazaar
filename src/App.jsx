...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full transition-colors duration-300 bg-white dark:bg-black text-neutral-900 dark:text-white relative">
      
      {/* Background Effect: Only visible in dark mode or subtle in light mode */}
      <div
        className="absolute inset-0 z-0 opacity-10 dark:opacity-100 pointer-events-none transition-opacity duration-500"
        style={{
          backgroundImage: `
      ...
      <div className="relative z-10">
        <header className="flex justify-between items-center px-8 py-6 border-b border-neutral-200 dark:border-neutral-800">
          ...
          <div className="flex items-center gap-6 text-xl">
            ...
            <a href="https://github.com/OMEE-Y" target="_blank" className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white transition-colors">
              <FaGithub />
            </a>
            <a href="https://x.com/omee_y" target="_blank" className="text-neutral-500 hover:text-neutral-900 dark:hover:text-white transition-colors">
              <FaXTwitter />
            </a>
          </div>
        </header>
        ...
        <main className="max-w-6xl mx-auto px-6 py-12">
          <input
            placeholder="Search subagents (React, Backend, DevOps...)"
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            className="w-full mb-10 p-4 rounded-xl border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all shadow-sm"
          />
          ...
          {filtered.length === 0 && (
            <div className="text-center py-20 text-neutral-500">
              No matching subagents found for "{query}"
            </div>
          )}
        </main>
      </div>
